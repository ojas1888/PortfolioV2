    ...
    >
      ...
      <div className="relative">
        ...
        {education.map((edu, index) => (
          ...
          >
            {/* Timeline Circle */}
            <div className="hidden sm:flex absolute left-1/2 transform -translate-x-1/2 bg-gray-400 border-4 border-[#8245ec] w-14 h-14 rounded-full justify-center items-center z-10">
              <img
                src={edu.img}
                alt={edu.school}
            ...
            <div
              className={`w-full sm:max-w-md p-6 sm:p-8 rounded-2xl shadow-2xl border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] transform transition-transform duration-300 hover:scale-105 ${
                index % 2 === 0
                  ? "sm:mr-[calc(50%+3rem)] sm:ml-auto"
                  : "sm:ml-[calc(50%+3rem)] sm:mr-auto"
              }`}
            >
              {/* Header (Logo + Details) */}
